...
<body>
 ...
 <hr/>
    <div class="userhome">
      Welcome <span style="color:#ff5c00">${user.username}</span>
      ...
      <a href="./addentry"><button type="button" class="addbtn">Add Entry</button></a>
       ...
       <c:if test="${entrieslist.size()==0}">
         <tr><td style="font-size:20px;color:green;text-align:center" colspan="4">User not added any Dairy Entries Till Now</td></tr>
       </c:if>
